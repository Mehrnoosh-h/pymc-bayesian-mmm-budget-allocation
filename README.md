...
This notebook uses the **multidimensional mock dataset** that ships with PyMC-Marketing (same as the official example).
...
Recommended approach (load from the packaged PyMC-Marketing data directory):
